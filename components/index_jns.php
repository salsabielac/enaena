      ...
      <div class="card-body">
        <table class="datatable table table-striped primary cellspacing="0" width="100%"">
          ...
          while ($data = $view->fetch_assoc()) {
            ...
            echo '<td>' .$no. "</td>";
            echo '<td>' .$data['id']. '</td>';
            echo '<td>' .$data['ket_jenis']. '</td>';  
             echo '<td>';
                echo '<a class="btn btn-success btn-sm" href="adm-jns-edit.php?id='.$data['id'].'" >';
                  echo '<span class="fa fa-pencil"></span>';
                echo '</a>';
                echo "&nbsp;";
                //Button Delete
                echo '<a class="btn btn-danger btn-sm" href="adm-jns.php?id='.$data['id'].'" >';
